...
<!-- BLOG-POST-LIST:START -->[kafka: event driven microservices](https://dev.to/wachuka_james/kafka-event-driven-microservices-1mei)[kafka:distributed task queue](https://dev.to/wachuka_james/kafkadistributed-task-queue-1175)[Building a Weather Data Pipeline with PySpark, Prefect, and Google Cloud](https://dev.to/wachuka_james/building-a-weather-data-pipeline-with-pyspark-prefect-and-google-cloud-19k8)<!-- BLOG-POST-LIST:END -->
<br>
<!--
