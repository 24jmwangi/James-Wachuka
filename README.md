...
<!-- BLOG-POST-LIST:START -->[kafka: event driven microservices](url)[kafka:distributed task queue](url)[Building a Weather Data Pipeline with PySpark, Prefect, and Google Cloud](url)<!-- BLOG-POST-LIST:END -->
<br>
<!--
